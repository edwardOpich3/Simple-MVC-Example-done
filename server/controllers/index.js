...
const searchDogName = (req, res) => {
  ...
  return Dog.findByName(req.query.name, (err, doc) => {
    ...
    // We found the dog! Be sure to update its age and send it back!
    const updated = doc;
    updated.age++;

    const savePromise = updated.save();
    ...
    return res.json({ name: updated.name, breed: updated.breed, age: updated.age });
  });
};
